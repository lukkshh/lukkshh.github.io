...
export default function FeatureCard() {
  return (
    <div className="min-h-[312px] md:w-[398px] relative rounded-xl flex items-end bg-[url(/images/about_card.svg)] bg-no-repeat bg-cover">
      <PurpleDecoration />
      <YellowDecoration />
      <p className="font-bold font-en z-50 text-white text-xl max-w-[75%] m-4">
