...
export default function Card({
  ...
  return (
    ...
    >
      <SpotlightCard className="w-full xl:max-w-[600px] min-h-[190px] drop-shadow-sm border-[0.1px] border-[#36374942] px-3 md:px-6 py-5 md:py-9 rounded-3xl bg-gradient-to-bl from-[#0C0E23] to-[#04071D] flex flex-col sm:flex-row items-start gap-4 sm:gap-8">
